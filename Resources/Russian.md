...
* [Общие вопросы](#Общие-вопросы)
    ...
    * [Documents vs Cache?](#Какой-контент-лучше-хранить-в-documents-а-какой-в-cache)
...
* [Многопоточность](#многопоточность)
    * [Runloop](#runloop)
    * [Достижение многопоточности в iOS и macOS](#Способы-достижения-многопоточности-в-ios-и-mac-os)
