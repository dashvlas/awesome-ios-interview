...
* [Паттерны](#Паттерны)
    ...
    * [Минусы Singleton](#Минусы-singleton)
...
* [Архитектура](#Архитектура)
    * [MVC. Пассивная/активная модель](#mvc-Чем-отличается-пассивная-модель-от-активной)
    * [MVVM](#mvvm)
    * [MVP](#mvp)
    * [Viper](#viper)
* [ООП](#ООП)
    ...
    * [Виртуальный метод](#Виртуальный-метод)
    * [Что такое нарушение инкапсуляции?](#Что-такое-нарушение-инкапсуляции)
...
* [Управление памятью](#Управление-памятью)
    ...
    * [Atomic vs <code>nonatomic</code>. Переопределение сеттера в MRC?](#atomic-vs-nonatomic-Переопределение-сеттера-в-mrc)
* [Язык](#Язык)
    ...
    * [Тип id](#Тип-id)
    * [Как работает механизм сообщений?](#Как-работает-механизм-сообщений)
...
* [Общие вопросы](#Общие-вопросы)
    ...
    * [Что такое назначенный инициализатор?](#Что-такое-назначенный-инициализатор)
...
* [БД](#БД)
    ...
    * [SQLite](#sqlite)
    * [Что такое NSManagedObjectId?](#Что-такое-nsmanagedobjectid)
    * [NSFetchedResultsController](#nsfetchedresultscontroller)
    * [Что такое контекст (Managed object context)?](#Что-такое-контекст-managed-object-context)
    * [Что такое Persistent store coordinator?](#Что-такое-persistent-store-coordinator)
    * [Какие есть нюансы при использовании Core Data в разных потоках?](#Какие-есть-нюансы-при-использовании-core-data-в-разных-потоках)
* [Многопоточность](#многопоточность)
    * [Runloop](#runloop)
    * [Достижение многопоточности в iOS и mac OS](#Способы-достижения-многопоточности-в-ios-и-mac-os)
    * [Что такое deadlock?](#Что-такое-deadlock)
    * [Что такое livelock?](#Что-такое-livelock)
    * [Что такое DispatchGroup?](#Что-такое-dispatchgroup)
    * [Разница между синхронными и асинхронными задачами](#Разница-между-синхронными-и-асинхронными-задачами)
    * [Зачем использовать synchronized?](#Зачем-использовать-synchronized)
    * [Что такое мьютекс (mutex)?](#Что-такое-мьютекс-mutex)
    * [Что такое семафор (semafor)?](#Что-такое-семафор-semafor)
...
От вышеперечисленных паттернов отличается тем, что не относится к категории MVC. Вместо привычных 3-х слоев он предлагает 5: View — ViewController — Router — Presenter — Interactor.

Interactor содержит бизнес-логику, связанную с данным (Entities).
...
Очень трудно изучать классы, не имея возможности их «пощупать». Только с приобретением небольшого опыта можно уверенно себя почувствовать при работе с использованием ООП. Поэтому проектирование классов — задача куда более сложная, чем их использование. Проектирование класса, как и проектирование языка, требует большого опыта. Это итеративный процесс, где приходится учиться на своих же ошибках.  
