...
- [Language](#language)
	...
	- [KVC](#kvc)
	- [Что такое быстрое перечисление (fast enumeration)?](#fast-enumeration)
	...
	- [Можно ли добавить ivar в категорию?](#ivar-and-category)
...
- [БД](#DB)
	...
	- [Целесообразность использования Core Data](#why-to-use-Core-Data)
	- [SQLite](#sqlite)
	...
	- [Какие есть нюансы при использовании Core Data в разных потоках?](#core-Data-in-different-threads)
- [CONCURRENCY](#concurrency)
	- [Runloop](#runloop)
	- [Способы достижения многопоточности в iOS и macOS](#concurrency-in-apple-platforms)
