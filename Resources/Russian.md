...
- [Patterns](#patterns)   
  ...
  - [Чем плох Singleton?](#чем-плох-singleton?)  
...
- [Language](#language)
	...
	- [KVC](#KVC)
	- [Что такое быстрое перечисление (fast enumeration)?](#Что-такое-быстрое-перечисление-(fast-enumeration)?)
	...
	- [Указатель isa](#Что-такое-указатель-isa?-Для-чего-он-нужен?)
	- [В чем отличие void* от id?](#В-чем-отличие-void*-от-id?)
	- [KVO](#KVO)
	- [`Atomic` vs `nonatomic`. Переопределение сеттера в MRC?](#`Atomic`-vs-`nonatomic`.-Переопределение-сеттера-в-MRC?)
...
- [БД](#БД)
	...
	- [Что такое ленивая загрузка? Что ее связывает с Core Data?](#Что-такое-ленивая-загрузка?-Что-ее-связывает-с-Core-Data?)
...
- [CONCURRENCY](#CONCURRENCY)
	- [Runloop](#Runloop)
	- [Способы достижения многопоточности в iOS и macOS](#Способы-достижения-многопоточности-в-iOS-и-macOS)
