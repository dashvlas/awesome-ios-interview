...
* [Language](#language)
    ...
    * [Что такое селектор (selector)? Как его вызвать?](#Что-такое-селектор-selector-Как-его-вызвать)
* [General](#general)
...
* [Concurrency](#concurrency)
    * [Runloop](#runloop)
    * [Способы достижения многопоточности в iOS и mac OS](#Способы-достижения-многопоточности-в-ios-и-mac-os)
