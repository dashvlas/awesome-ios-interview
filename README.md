...
## Select language
This repo is intended to provide you with a big QA database for an iOS-Interview. We support 2 languages in README and our app. From here you can just select the one and get started!
...
## About an app
It's more convenient to have a nice mobile solution to prepare for the big interview day on the go. You are welcome to install free app from the App Store ➡ http://appstore.com/awesomeinterview   
